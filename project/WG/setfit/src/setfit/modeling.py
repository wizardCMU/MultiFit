...
def sentence_pairs_generation(sentences, labels, pairs, is_classification):
    ...
    for first_idx in range(len(sentences)):
        ...
        if is_classification:
            pairs.append(InputExample(texts=[current_sentence, positive_sentence], label=int(1)))
        else:
        ...
        if is_classification:
            pairs.append(InputExample(texts=[current_sentence, negative_sentence], label=int(0)))
        else:
